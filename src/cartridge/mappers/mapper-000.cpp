...
uint8_t Mapper000::CpuRead(uint16_t address)
{
    ...
    std::cerr << "CPU tried to read from the cartridge at an unexpected address (" 
        << address << ")" << std::endl;
    return 0;
}
...
{
    std::cerr << "CPU tried to write to the cartridge at an unexpected address (" 
        << address << ")" << std::endl;
}
...
uint8_t Mapper000::PpuRead(uint16_t address)
{
    ...
    std::cerr << "PPU tried to read from the cartridge at an unexpected address ("
        << address << ")" << std::endl;
    return 0;
}
...
{
    std::cerr << "PPU tried to write to the cartridge at an unexpected address ("
        << address << ")" << std::endl;
}
